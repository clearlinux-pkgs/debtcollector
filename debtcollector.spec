...
Source0  : http://tarballs.openstack.org/debtcollector/debtcollector-1.22.0.tar.gz
Source1 : http://tarballs.openstack.org/debtcollector/debtcollector-1.22.0.tar.gz.asc
...
%prep
%setup -q -n debtcollector-1.22.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1567639092
